...
class PengirimanObat extends CI_Controller {
    ...
    public function history_pengiriman_obat(){
        ...
        $config = $this->mypagination->paginate(5, 4, $count_rows, base_url('admin/PengirimanObat/history_pengiriman_obat'));
