...
class RekamMedis extends CI_Controller {
    ...
    public function index(){
        $data['view'] = 'dokter/homecare/rekam_medis';
        ...
        $data['list_rm'] = $this->db->query('SELECT 
                                                ...
                                                FROM data_registrasi_homecare drh 
                                                    ...
                                                    INNER JOIN detail_pasien dp ON dp.id_pasien = p.id 
        ...
        foreach($data['list_rm'] as $rm){
            ...
            $rm->no_medrec = str_split($rm->no_medrec, 2);
            $rm->no_medrec = implode('.', $rm->no_medrec);
        }
