...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="<?php echo base_url('News');?>" class="nav-link">BERITA</a></li>
    ...
    <section class="ftco-section ftco-services">
      ...
      <div class="row justify-content-center mb-5 pb-0">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-3">Berita Tentang Kesehatan</h2>
          </div>
        </div>
              ...
              <div class="list-services d-flex ftco-animate">
                ...
                <div class="col-md-4">
                  <span class="icon-check2"></span>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          <img src="<?php echo base_url('assets/images/news/'.$berita->foto);?> " width="250" height="150" style="border-radius: 10px; border-color: white">
                        </div>
                        <div class="col-md-8">
                          <h3><a href="<?php echo base_url('news/detail_news/'.$berita->id) ?>" class="text-white"><?php echo $berita->judul; ?></a></h3>
                          <p class="text-white"><?php echo substr($berita->berita,3,200); ?></p>  
                          <p><a href="<?php echo base_url('news/detail_news/'.$berita->id) ?>" class="btn btn-primary btn-outline-primary text-white"> Lihat Selengkapnya...</a></p>
                        </div>
                    </div>
                </div>
      				</div>
    ...
    <section class="ftco-section">
      <div class="container">
      	<div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-3">Temui Spesialis Pengalaman Kami</h2>
          </div>
        </div>
        <div class="row">
        	<?php foreach($list_dokter as $dokter){ ?>
              <?php if(strtolower($dokter->jenis_kelamin) == 'laki-laki'){
                    ...
                    $pengalaman_dari = $pengalaman != '' ? (new DateTime(rtrim($pengalaman[0]))):'';
                    $pengalaman_sampai = $pengalaman != '' ? (new DateTime(ltrim($pengalaman[1]))):'';
          ...
          <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				<div class="img mb-4" style="background-image: url(<?php echo $foto; ?>);"></div>
      				<div class="info text-center">
      					<h3><?php echo $dokter->nama_dokter ?></h3>
      					<span class="position"><?php echo 'Dokter '.$dokter->poli ?></span>
      					<div class="text">
                  <p><?php echo $lama_pengalaman.' Tahun Pengalaman' ?></p>
	        			</div>
      				</div>
        		</div>
        	</div>
