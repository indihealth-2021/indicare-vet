        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Jadwal Suster</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Jadwal Suster</h3>
            </div>
            <!-- /.card-header -->
            <div>
            </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>                                            
                                            ...
                                            <th style="text-align:center">Banyak Pasien</th>
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">                                            
                                            <td style="text-align:center;vertical-align:middle">Senin</td>
                                            <td style="text-align:center;vertical-align:middle">5 JAM</td>
