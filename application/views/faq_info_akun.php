...
<head>
  <title>Indicare Vet For Vet Clinic | Faq</title>
  <meta charset="utf-8">
          ...
          <div class="accordion" id="info">
              ...
              <div class="" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn btn-faq btn-block text-left" type="button" data-toggle="collapse" data-target="#info1" aria-expanded="true" aria-controls="info1"><i class="fas fa-caret-down"></i>
                    Bagaimana cara daftar akun Telemedicine App?
                  </button>
                </h2>
              </div>
              ...
              <div id="info1" class="collapse show" aria-labelledby="headingOne" data-parent="#info">
                <div class="pl-3 mb-3 font-18 text-justify">
                  <ul>
                    ...
                    <li>Proses pendaftaran akan meminta informasi nama lengkap, nama pengguna, nomor telepon, email, kata sandi, tempat lahir, tanggal lahir, dan jenis kelamin.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="info3">
              ...
              <div id="info3" class="collapse" aria-labelledby="headingThree" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Melakukan reset ulang password dengan cara memasukkan email yang pernah didaftarkan sebelumnya untuk mendapatkan langkah-langkah pembuatan password baru.
                </div>
              </div>
            </div>
            <div class="info4">
              ...
              <div id="info4" class="collapse" aria-labelledby="headingFour" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Keamanan data pasien terjamin karena di lingkungan Rumah Sakit dan Internal Cloud Lintasarta.
                </div>
              </div>
            </div>
            <div class="info5">
              ...
              <div id="info5" class="collapse" aria-labelledby="headingFive" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Ya, dapat diganti oleh pasien pada halaman edit profil kemudian pilih ubah nama pengguna.
                </div>
              </div>
            </div>
          </div>
