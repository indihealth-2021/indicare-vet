                    ...
                    <div class="col-md-12 chat-header rounded-top p-2">
                        <div class="row">
                            <div class="col-2 image">
                                <img src="<?php echo $dokter->foto ? base_url('assets/images/users/'.$dokter->foto) : base_url('assets/telemedicine/img/default.png');?>" class="img-rounded" style="border-radius: 50%">
                            </div>
                            <div class="col-7 user-detail pt-2">
                                <h6 class="pt-1"><?php echo ucwords($dokter->name) ?></h6>
                                ...
                                <div class="form-row">
                                  <div class="col-lg-12">
                                    <div class="input-group mb-2">
                                        <form id="form-message" class="col-lg-12" style="margin-left: 15px" >
                                            <div class="row">
                                                <div class="col-9">
                                                    ...
                                                    <div class="file-upload">
                                                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                              <div class="btn-group" role="group">
                                                                <label type="file" for="attachment" style="padding-top: 10px" id="attachment_label"><i class="fa fa-paperclip fa-lg" aria-hidden="true"></i></label>
                                                              </div>
                                                            </div>
...
id_dokter = <?php echo $this->uri->segment(4) ?>;
