             ...
             <div class="col-sm-12 col-12 ">
                 <nav aria-label="">
                     <ol class="breadcrumb" style="background-color: transparent;">
                         ...
                         <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('pasien/homecare/JadwalPelayanan') ?>" class="text-black font-bold-7"><?= $title ?></a></li>
                     </ol>
                 </nav>
             </div>
             <div class="col-sm-12 col-12">
                 ...
                 <table class="table table-border table-hover custom-table mb-0" id="table_jadwal">
                     ...
                     <tbody class="font-14">
                        <?php foreach($list_jadwal_pelayanan as $idx=>$jadwal_pelayanan){ ?>
                            <tr>
                                <td><?= $idx+1 ?></td>
                                <td><?= $jadwal_pelayanan->nama_dokter ?></td>
                                <td><?= $jadwal_pelayanan->list_nama_pelayanan ?></td>
                                <td><?= $jadwal_pelayanan->alamat_pelayanan ?></td>
