    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <div class="logo">
                    <a href="#" class="">
                        <div class="bg-logo-sidebar p-2 text-center"><img src="<?php echo base_url('assets/dashboard/img/IndicareForVetClinic.png'); ?>" class="ml-3" alt=""><span></span></div>
                    </a>
                </div>
                <ul>
                    <?php if ($user->id_user_level == 1) { ?>
                        ...
                        <li class="<?php if (isset($this->uri->segments[2]) && isset($this->uri->segments[3])) {
                                        echo strtolower($this->uri->segments[2]) == 'homecare' && strtolower($this->uri->segments[3]) == 'pendaftaran' ? 'active' : '';
                                    } ?>">
                        ...
                        <li class="submenu">
                            <a href="#" class="<?php if (isset($this->uri->segments[2]) && isset($this->uri->segments[3])) {
                                                    echo strtolower($this->uri->segments[2]) == 'homecare' && strtolower($this->uri->segments[3]) == 'pembayaran' ? 'active' : '';
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="<?php if (isset($this->uri->segments[4])) {
                                                echo strtolower($this->uri->segments[2]) == 'homecare' && strtolower($this->uri->segments[3]) == 'pengirimanobat' && !$this->uri->segments[4] ? 'active' : '';
                                            } ?>">
                        ...
                        <li class="submenu <?php //if(isset($this->uri->segments[2])){echo strtolower($this->uri->segments[2]) == 'pembayaran' ? 'active' : '';} 
                            ...
                            <ul>
                                <li class="<?php if (isset($this->uri->segments[4])) {
                                                echo strtolower($this->uri->segments[2]) == 'homecare' && strtolower($this->uri->segments[4]) == 'riwayat_pembayaran_layanan' ? 'active' : '';
                                            } ?>"><a href="<?php echo base_url('admin/homecare/pembayaran/riwayat_pembayaran_layanan') ?>">Layanan</a></li>
                                <li class="mb-5 <?php if (isset($this->uri->segments[4])) {
                                                    echo strtolower($this->uri->segments[2]) == 'homecare' && strtolower($this->uri->segments[4]) == 'riwayat_pembayaran_obat' ? 'active' : '';
                                                } ?>"><a href="<?php echo base_url('admin/homecare/Pembayaran/riwayat_pembayaran_obat') ?>">Obat</a></li>
                            </ul>
                        </li>
                        <hr>
                        ...
                        <li class="submenu">
                            <a href="#" class="<?php //cho strtolower($this->uri->segments[3]) == 'jadwal_dokter' ? 'active' : ''; 
