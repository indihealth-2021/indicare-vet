                 ...
                 <?php foreach ($list_resep as $idx => $resep) {
                   ...
                   <tr class="text-top">
                     ...
                     <td class="text-top">
                       ...
                       <?php
                        ...
                        for ($i = 0; $i < $jml_data; $i++) {
                          $list_total_harga[$i] = ((int) $list_jumlah_obat[$i] / (int) $list_harga_obat_per_n_unit[$i]) * (int) $list_harga_obat[$i];
                        }
                     ...
                     <td class="text-center" width="10%">
                       ...
                       <a href="<?php echo base_url('admin/homecare/FarmasiVerifikasiObat/verifikasi/' . $resep->id_registrasi); ?>" onclick="return confirm('Apakah anda yakin untuk verifikasi resep ini?');" class="mb-3 btn btn-tele-verif mt-2">Verifikasi</a>
                       <a class="btn btn-tele-one" href="<?php echo base_url('admin/homecare/FarmasiVerifikasiObat/form_edit_resep/' . $resep->id_registrasi); ?>">Edit</a>
                     </td>
                   </tr>
                 <?php } ?>
               </tbody>
