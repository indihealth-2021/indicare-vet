        ...
        <div class="col-lg-5">
          <div>
            ...
            <div class="font-notosans">
              ...
              <script>
                console.log('abcd - <?= $this->session->flashdata('error_on_regis') ?>')
              </script>
              ...
              <div class="input-icon">
                <input required type="text" class="form-control" id="username" <?php if ($this->session->flashdata('error_on_regis')) {
                                                                                  if ($this->session->flashdata('error_on_regis') != 'username' && $this->session->flashdata('error_on_regis') != 'usernameAndEmail') {
              ...
              <div class="input-icon">
                <input required type="email" class="form-control" <?php if ($this->session->flashdata('error_on_regis')) {
                                                                    if ($this->session->flashdata('error_on_regis') != 'email' && $this->session->flashdata('error_on_regis') != 'usernameAndEmail') {
