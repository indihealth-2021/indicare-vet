        ...
        <div class="col-lg-5">
          <div>
            ...
            <div class="font-notosans">
              ...
              <script>console.log('abcd - <?= $this->session->flashdata('error_on_regis') ?>')</script>

              <?= form_open('Register/register', 'onsubmit="return ubah();"'); ?>
                <?php if ($this->session->flashdata('msg')) {
                  echo '<div class="alert-danger border pb-1">' . $this->session->flashdata('msg') . '</div>';
                } ?>
                <label for="exampleFormControlInput1" class="form-label">Nama</label>
                <div class="input-icon">
                  <input type="text" class="form-control" <?php echo $old ? ' value="' . $old['name'] . '" ' : ' '; ?>id="name" name="name" placeholder="Masukan Nama">
                ...
                <div class="input-icon">
                  <input required type="text" class="form-control" id="username" <?php if($this->session->flashdata('error_on_regis')){if ($this->session->flashdata('error_on_regis') != 'username' && $this->session->flashdata('error_on_regis') != 'usernameAndEmail') {
                ...
                <div class="input-icon">
                  <input required type="email" class="form-control" <?php if($this->session->flashdata('error_on_regis')){if ($this->session->flashdata('error_on_regis') != 'email' && $this->session->flashdata('error_on_regis') != 'usernameAndEmail') {
                ...
                <div class="input-icon">
                  <input required type="password" class="form-control" id="password" name="password" placeholder="Masukan Password">
